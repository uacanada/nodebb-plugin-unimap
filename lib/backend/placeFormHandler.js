...
module.exports.handleAddPlaceRequest = async function (req, res, helpers) {
    ...
    try {
        const settings = await meta.settings.get('unimap')
        ...
        if (fields.tid) {
            ...
            if (editAttempt.error) {
                ...
                oldFields = await db.getObjectField('unimap:places', fields.tid);
            }
        ...
        await db.setObjectField(`unimap:places`, tid, fields);
